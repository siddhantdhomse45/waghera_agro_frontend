...
//                 <div>
//                     <h2 className="text-3xl mb-3 text-[#ccb28d]">Luxurious Comfort Awaits</h2>
//                     <p className="text-lg text-gray-700 leading-relaxed">
//                         Step into the Executive Room, where elegance meets modern comfort. Spacious layout, plush furnishings, and calming views make this perfect for discerning guests. Enjoy amenities like high-speed WiFi, premium bedding, balcony access, and a work desk. Your retreat is designed for both relaxation and productivity.
//                     </p>
//                 </div>
//                 <div>
//                     <img
...
//             {/* Gallery section */}
//             <h3 className="text-2xl font-semibold text-[#a1865e] mb-5 text-center">Gallery</h3>
        ...
        <div className="max-w-6xl mx-auto px-4 py-10 mt-30 font-serif">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
                <div>
                    <h2 className="text-3xl mb-3 text-[#ccb28d]">Luxurious Comfort Awaits</h2>
                    <p className="text-lg text-gray-700 leading-relaxed">
                        Step into the Executive Room, where elegance meets modern comfort. Spacious layout, plush 
                        furnishings, and calming views make this perfect for discerning guests. Enjoy amenities like 
                        high-speed WiFi, premium bedding, balcony access, and a work desk. Your retreat is designed 
